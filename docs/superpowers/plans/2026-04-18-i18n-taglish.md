...
- [ ] **Step 3: Manual smoke — toggle the locale on the homepage**
...
- [ ] **Step 1: Create `footer-tagline.tsx`**
...
- [ ] **Step 4: Manual smoke — footer switches locale**
...
- [ ] **Step 2: Update `/about/page.tsx` — three replacements**
...
- [ ] **Step 4: Manual smoke — /about page switches locale**
...
- [ ] **Step 3: Manual smoke — /app page switches locale**
...
- [ ] **Step 1: Mark item #3 resolved in FOLLOWUPS.md**
